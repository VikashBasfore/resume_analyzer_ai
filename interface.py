...
st.subheader('''This page helps you to compare your resuma with the given Job description''')

st.sidebar.subheader("Drop your resume here🛠️")

pdf_doc = st.sidebar.file_uploader('Click here to browse', type=['pdf'])

st.sidebar.markdown('Designed by Vikash Basfor')
st.sidebar.markdown("[GitHub Profile](https://github.com/VikashBasfore)")
